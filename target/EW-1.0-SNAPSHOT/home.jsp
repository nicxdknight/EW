...
<!--      <li class="nav-item active">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="allProducts.html" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
         Products
        </a>
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            <a class="dropdown-item" href="view_all_items.html">Electronics</a>
    ...
    <li class="nav-item">
      ...
      <li class="nav-item">
          <button type="button" style="width: 180px;height: 30px;background-color: black;border: 0px;font-size:18px;" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Deliver for us</button>
      </li>
...
<div class="btn-group">
    <button type="button" id="but" class="btn btn-danger dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
   <%=email%>
  </button>
...
<!--          <button type="button" class="close" data-dismiss="modal">&times;</button>-->
          <h6 class="modal-title">Become Our Delivery Partner</h6>
        </div>
        <div class="modal-body">
          <p>Please Mail your company details and tariff to:deliveryew@ew.com</p>
        </div>
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      ...
      <div class="carousel-item">
      <img src="img/14.jpg" height="600px" width="100px" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="img/15.jpg"height="600px" width="100px"  class="d-block w-100" alt="...">
    </div>
  </div>

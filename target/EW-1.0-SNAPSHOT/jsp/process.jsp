...
int i=st.executeUpdate("insert into seller(name,item,price)values('"+name+"','"+item+"','"+price+"')");
...
<!--    <form class="form-inline my-2 my-lg-0">
      ...
      <button class="btn btn-outline-success my-2 my-sm-0" type="submit"><a href="logout.jsp">Logout</a></button>
        ...
        <button type="button" class="btn btn-outline-danger" style="margin-top: 100px;margin-left: 45%;border: 0px;" ><%out.println("Data is successfully inserted!");%></button>

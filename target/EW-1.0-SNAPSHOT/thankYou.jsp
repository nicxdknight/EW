<%-- 
    ...
    Created on : 16-Jun-2020, 9:53:22 PM
    Author     : harsh
--%>
...
<div class="btn-group">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
   ...
   <div class="jumbotron text-center" style="background: linear-gradient(to right, #070a07, #801d50);">
  <h1 class="display-3">Thank You!</h1>
  <p class="lead"><strong>Please check your email</strong> for further instructions on how to complete your account setup.</p>
  <hr>
  <p>
    Having trouble? <a href="home.jsp">Contact us</a>
  </p>
  <p class="lead">
    <a class="btn btn-primary btn-sm" href="my_order.html" role="button">My Orders</a>
  </p>
  <p class="lead">

<%-- 
    Document   : view_cart
    Created on : 15-Jun-2020, 12:52:46 AM
    Author     : harsh
--%>
...
<div class="btn-group">
  ...
  %>
    ...
    <a href="ViewAllItems"><button> Add Items </button></a>
    <%     
        } else {
    %> 
  ...
  <tr>
   ...
   <tr>
       ...
       <a href="ViewAllItems"><button> Add More Items </button></a><br>
       <form action="RemoveFromCart">
           Remove id :- <input type="text" name="id">
           <input type="submit">
       </form>
   <%
       }

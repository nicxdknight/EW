 ...
 * @author harsh
 */
@WebServlet(name = "AddToCartServlet", urlPatterns = {"/AddToCartServlet", "/add_to_cart.html"})
public class AddToCartServlet extends HttpServlet {
    private final ItemDao itemData;

    public AddToCartServlet() throws ClassNotFoundException, FileNotFoundException {
